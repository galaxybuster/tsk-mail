...
class RainTPL{
	...
	// -------------------------
		...
		// Dont set write permission just let it render for us
		static $RAINTPL_CHECK_TEMPLATE_UPDATE = false;
		 ...
		 *
		 */
		static $check_template_update = false;
	...
	const CACHE_EXPIRE_TIME = 1;//3600; // default cache expire time = hour
